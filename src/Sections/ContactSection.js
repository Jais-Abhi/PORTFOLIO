...
const ContactSection = () => {
  return (
    <div id='contact' className='  scroll-mt-12 p-4 lg:p-8 max-lg:flex-col  rounded-4xl mt-20 flex lg:items-center w-full lg:w-4/5 lg:mx-auto bg-linear-to-r from-emerald-400 to-blue-400' >
